...
get_user_preferences('drawer-open-nav', PARAM_ALPHA);
get_user_preferences('sidepre-open', PARAM_ALPHA);
get_user_preferences('darkmode-on', PARAM_ALPHA);
get_user_preferences('drawer-open-index', PARAM_BOOL);
get_user_preferences('drawer-open-block', PARAM_BOOL);
